...
function edit_lock_sidebar($plugin_name, $wdm_plugin_slug)
{
...
<?php     
   if(isset($_POST["cde-submit"]))
   {
      ...
      add_filter( 'wp_mail_from', 'editor_lock_mail_from' );
      add_filter( 'wp_mail_from_name', 'editor_lock_mail_from_name' );
      add_filter('wp_mail_content_type','editor_lock_set_contenttype');
	...
	<?php
      ...
      remove_filter( 'wp_mail_from', 'editor_lock_mail_from' );
      remove_filter( 'wp_mail_from_name', 'editor_lock_mail_from_name' );
      remove_filter('wp_mail_content_type','editor_lock_set_contenttype');
   }
}

function editor_lock_set_contenttype()
{
   return 'text/html';
}

function editor_lock_mail_from($email)
{
   $email = isset($_POST["cde-email"]) ? $_POST["cde-email"] : '';
   return $email;
}

function editor_lock_mail_from_name($name)
{
